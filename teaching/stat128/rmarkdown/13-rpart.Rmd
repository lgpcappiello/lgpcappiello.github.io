...
rm(body) # get rid of original data so we don't accidentally use it!
```
...
An approach called *cross validation* generalizes this idea of splitting the data into a test and a training dataset. 
